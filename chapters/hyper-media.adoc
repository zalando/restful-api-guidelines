...
[#163]
== {TODO} {MAY} use REST maturity level 3 - HATEOAS
...
[#164]
== {TODO} {MUST} use common hypertext controls
...
[#165]
== {TODO} {SHOULD} use simple hypertext controls for pagination and self-references
...
[#217]
== {TODO} {MUST} use full, absolute URI for resource identification
...
[#166]
== {TODO} {MUST} not use link headers with JSON entities
