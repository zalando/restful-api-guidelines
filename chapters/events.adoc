...
[#213]
== {MUST} Event names must match Zalando naming schema
...
functional-component ::= [a-z][a-z0-9-]* ; functional name of the component sending the event
...
see <<218>>. They must correspond to the functional name
of the application producing the event and are currated by central architecture team support
