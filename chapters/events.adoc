...
DailyPay's architecture centers around decoupled microservices and in
...
In DailyPay's architecture, events are registered using a structure
  ...
  properties:
    ...
    audience:
      ...
      description: |
        ...
        in rule #219 -- see https://opensource.dailypay.com/restful-api-guidelines/#219
    owning_application:
      description: |
