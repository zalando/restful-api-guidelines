[[events]]
= EVENT Basics - Event Types ( Under Construction)

LINZ currently does not have a well defined Events Driven Architecture or Events Centre of Excellence (COE, COP),
once it does then this section will be review and standards updated.


LINZ architecture centers around decoupled microservices and in
