      ...
      properties:
        ...
        ordering_key_field:
          description:
            ...
            This is a JsonPath-like expression, which is applied on the whole event
            object, including metadata and data fields.
          type: string
      required:
        - type
        - schema
...
In the event type definition, the `ordering_key` property should be
used to indicate which field contains the ordering key, if any.
