...
concurrent system without ordered atomic event publication. While the order 
information is mandatory for data change events, it is recommended to be also 
provided for general (aka business) events. Providing explicitly the order of 
