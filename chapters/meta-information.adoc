...
- `#/info/x-api-id` unique identifier of the API (<<107, see rule 107>>)
- `#/info/x-audience` intended target audience of the API (<<108, see rule 108>>)
...
API evolution. By using  <<106, API semantic version information>> or <<192,
