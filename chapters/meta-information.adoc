...
specification versions describing the same API. This explicitly covers all
applications and deployments as well as compatible and incompatible changes
of the API that are noticeable addressing the same purpose and consumer group.
