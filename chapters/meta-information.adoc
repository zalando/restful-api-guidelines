...
[#218]
== {TODO} {MUST} contain API meta information
...
[#116]
==  {TODO} {MUST} use semantic versioning
...
[#215]
== {TODO} {MUST} provide API identifiers
...
[#223]
== {TODO} {MUST-SHOULD-MAY} use functional naming schema
...
[#224]
== {TODO} {MUST} follow naming convention for hostnames
