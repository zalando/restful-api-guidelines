...
To foster a consistent look and feel response object for paginating over
collections should follow a common pattern using the following pagination
field semantics:

* [[first]]{first}: the cursor or link in a pagination response pointing to
  the first page.
* [[prev]]{prev}: the cursor or link in a pagination response pointing to the
  previous page.
* [[self]]{self}: the cursor or link in a pagination response pointing to the
  current page.
* [[next]]{next}: the cursor or link in a pagination response pointing to the
  next page.
* [[last]]{last}: the cursor or link in a pagination response pointing to the
  last page.
