...
SalesOrder:
  properties:
    grand_total:
      $ref: 'https://opensource.dailypay.com/restful-api-guidelines/models/money-1.0.0.yaml#/Money'
----
...
* [[xyz_id]]{xyz_id}: an attribute within one object holding the identifier of
  ...
  *Exception*: We use `customer_number` instead of `customer_id` for customer facing
  ...
  https://api.dailypay.com/redirect/5675b6ec-8934-11ea-929e-68f728c1ba70[Naming
...
allows API client developers to build up a common understanding of DailyPay's
