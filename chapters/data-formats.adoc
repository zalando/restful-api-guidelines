...
In some situations the API supports serving different representations of a specific resource (at the same URI), 
for instance, JSON, PDF, TEXT, HTML representations for an invoice resource. 
