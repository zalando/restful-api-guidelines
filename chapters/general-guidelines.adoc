...
[#100]
== {STATUS_RFP} {MUST} follow API first principle
...
[#101]
== {STATUS_RFP} {MUST} provide API specification
...
[#234]
== {STATUS_RFP} {MUST} only use durable and immutable remote references
...
[#102]
== {STATUS_RFP} {MAY} provide API user manual
...
[#103]
== {STATUS_RFP} {MUST} write APIs using U.S. English
