...
In addition to the API Specification, it is good practice to provide examples and a meaningful
summary to explain e.g. background processes.
...
Due to the fact, that's sometimes necessary to reference external documentations
such URLs are explicitly allowed.