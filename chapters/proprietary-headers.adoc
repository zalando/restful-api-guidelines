...
[cols="11%,10%,60%,11%,8%",options="header",]
|=======================================================================
|Header field name |Type |Description |Header field value example| Parameter Reference

|[[x-flow-id]]{X-Flow-ID}|String|
For more information see <<233>>.
|GKY7oDhpSiKY_gAAAABZ_A
|`$ref: "https://opensource.zalando.com/restful-api-guidelines/headers/schema.yaml#/X-Flow-ID"`
...
|`$ref: "https://opensource.zalando.com/restful-api-guidelines/headers/schema.yaml#/X-Tenant-ID"`
...
|`$ref: "https://opensource.zalando.com/restful-api-guidelines/headers/schema.yaml#/X-Sales-Channel"`
...
|mobile-app
|`$ref: "https://opensource.zalando.com/restful-api-guidelines/headers/schema.yaml#/X-Frontend-Type"`
...
|tablet
|`$ref: "https://opensource.zalando.com/restful-api-guidelines/headers/schema.yaml#/X-Device-Type"`
...
|Android
|`$ref: "https://opensource.zalando.com/restful-api-guidelines/headers/schema.yaml#/X-Device-OS"`
...
All proprietary headers can also be referenced as pre defined parameters e.g.
[source,yaml]
----
parameters:
- $ref: "https://opensource.zalando.com/restful-api-guidelines/headers/schema.yaml#/X-Flow-ID"
