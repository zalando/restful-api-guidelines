...
can either be https://developer.apple.com/documentation/adsupport/asidentifiermanager[Apple 
IDFA] (iOS) or the https://support.google.com/googleplay/android-developer/answer/6048248[Goggle 
AddID] (Android)
