...
|X-Advertising-ID |String |An app specific, unique customer resettable 
id for advertising purposes. It is not sent if the customer disables it 
in the settings for respective platform. |b89fadce-1f42-46aa-9c83-b7bc49e76e1f
