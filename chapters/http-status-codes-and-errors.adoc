...
https://opensource.zalando.com/restful-api-guidelines/models/problem-1.0.2.yaml[on
...
responses:
  503:
    ...
    content:
      "application/problem+json":
        schema:
          $ref: 'https://opensource.zalando.com/restful-api-guidelines/models/problem-1.0.2.yaml#/Problem'
----
...
please reference
https://opensource.zalando.com/restful-api-guidelines/models/problem-1.0.2.yaml#/Problem[problem-1.0.2.yaml#/Problem]
instead.
