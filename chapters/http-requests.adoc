...
parameter. The form-style query format should be used as described in
https://tools.ietf.org/html/rfc6570#section-3.2.8[RFC6570 standard].
The set of parameter values should be supplied either in comma-separated
or multiple parameter instances format. One particular type should be selected
and stated explicitly in the API specification.

In the OpenAPI 3, the 
https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.0.md#style-values[`style`]
and `explode` fields of the
https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.0.md#parameter-object[parameter object]
are used to specify the format of parameter supply.
In the OpenAPI 2, it is the http://swagger.io/specification/[`collectionFormat`]
property.

[,cols="20%,20%,25%,35%",options="header",]
|=======================================================================
|Description |OpenAPI 3 |OpenAPI 2 |Example
|Comma separated values |`style: form, explode: false` |`collectionFormat: csv` |`?parameter=value1,value2`
|Multiple parameter instances |`style: form, explode: true` |`collectionFormat: multi` |`?parameter=value1&parameter=value2`
|=======================================================================
