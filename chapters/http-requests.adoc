...
* successful {DELETE} requests return {200} or {204} (if the resource was updated - 
  with or without returning the resource).
...
Hence, clients can differentiate successful robust repetition vs. successful (initial) created. 
