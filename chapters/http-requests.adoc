...
paths:
  /products:
    post:
      description: >
        [GET with body payload](https://opensource.dailypay.com/restful-api-guidelines/#get-with-body) - no resources created:
...
* `name=DailyPay`, to query for elements based on property equality
