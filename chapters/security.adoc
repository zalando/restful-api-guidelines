[[security]]
= REST Basics - Security ( Under Construction)

The entire Security Section is under review and will be updated after the auth work with keycloak and design becomes
more apparent.

[#104]
== {MUST} secure endpoints ( Under Construction)
...
[#105]
== {MUST} define and assign permissions (scopes) ( Under Construction)
...
[#225]
== {MUST} follow naming convention for permissions (scopes) ( Under Construction)
