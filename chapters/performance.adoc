[[performance]]
= {TODO} REST Design - Performance


[#155]
== {TODO} {SHOULD} reduce bandwidth needs and improve responsiveness
...
[#157]
== {TODO} {SHOULD} support partial responses via filtering
...
[#158]
== {TODO} {SHOULD} allow optional embedding of sub-resources
