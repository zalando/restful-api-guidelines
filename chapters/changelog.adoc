...
* `2017-11-24:` Added best practices section including discussion about optimistic locking approaches.
...
* `2017-02-28:` Extended information about how to reference sub-resources and the usage of composite identifiers in the <<142>>
part.
