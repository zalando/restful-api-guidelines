...
To see a list of all changes, please have a look at the https://github.com/nifty10m/restful-api-guidelines/commits/master[commit list in Github].

[[rule-changes]]
== Rule Changes

* `2018-09-01:` Forked the Zalando API to create a separate version for 10M GmbH
