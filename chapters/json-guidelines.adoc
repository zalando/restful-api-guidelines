...
[#252]
== {SHOULD} {TODO} design single resource schema for reading and writing
...
[#118]
== {MUST} {TODO} property names must be snake_case (and never camelCase)
...
[source]
----
customer_number, app_version, machine_network_name
----
...
[#235]
== {SHOULD} {TODO} use naming convention for date/time properties
...
[#174]
== {MUST} {TODO }use common field names and semantics
