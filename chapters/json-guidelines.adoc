...
These guidelines provides recommendations for defining JSON data at DailyPay.
...
The guidelines clarifies some specific cases to allow DailyPay JSON data to have
