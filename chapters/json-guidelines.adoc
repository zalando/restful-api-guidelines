...
Others, like Google and Amazon, use both - not only camelCase. However will the predominate languages in LINZ being
Typescript and Kotlin both of which use camelCasing, camelCasing is expected.
