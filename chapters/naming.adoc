...
should be ready here). The special case of a _resource singleton_ is a
collection with cardinality 1 --  to be highlighted in the resource 
definition description.

**Exception:** The 'pseudo identifier' `self` is the only exception --  see <<143>>.
