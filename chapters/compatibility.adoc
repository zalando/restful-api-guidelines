...
`application/x.dailypay.ewa+json;version=2`. For incompatible changes, a new
...
* `custom-media-type` is a custom type name, e.g. `dailypay.ewa`
...
[source,http]
----
Accept: application/x.dailypay.ewa+json;version=2
----
...
[source,http]
----
Content-Type: application/x.dailypay.ewa+json;version=2
----

Using media type versioning should:

* Use a custom media type, e.g. `application/x.dailypay.ewa+json`
