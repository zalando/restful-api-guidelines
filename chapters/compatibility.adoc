...
[#106]
== {STATUS-RFP} {MUST} not break backward compatibility
...
[#107]
== {STATUS-RFP} {SHOULD} prefer compatible extensions
...
[#108]
== {STATUS-RFP} {MUST} prepare clients accept compatible API extensions
...
[#109]
== {STATUS-RFP} {SHOULD} design APIs conservatively
...
[#110]
== {STATUS-RFP} {MUST} always return JSON objects as top-level data structures if JSON is being used
...
[#112]
== {STATUS-RFP} {SHOULD} refrain from using enumerations
...
[#113]
== {STATUS-RFP} {SHOULD} avoid versioning

When changing your APIs, do so in a compatible way and avoid generating
additional API versions unless the API is non-functional or is degraded. 
Multiple versions can significantly complicate understanding, testing, 
maintaining, evolving, operating and releasing our systems
...
[#114]
== {STATUS-TODO} {MUST} API Versioning Has No “Right Way”
...
[#115]
== {STATUS-RFP} {SHOULD} use URI versioning
