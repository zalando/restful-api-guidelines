...
Verify HTTP content-type header with the Valimail Community

`application/x.valimail+json;version=1`. For incompatible changes, a new
...
[source,http]
----
Accept: application/x.valimail+json;version=1
----
...
[source,http]
----
Content-Type: application/x.valimail+json;version=1
----
