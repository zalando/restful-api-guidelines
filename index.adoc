...
:creator: Valimail Inc.
:producer: Asciidoctor
:keywords: Valimail, Guidelines, RESTful, API, Events, Schema
...
= Valimail RESTful API and Event Scheme Guidelines

image::assets/api-zalando-small.jpg[API Guild Logo]

Other formats: link:valimail-guidelines.pdf[PDF], link:valimail-guidelines.epub[EPUB3]
