...
:keywords: Guidelines, RESTful, API, Events, Schema
...
:TODO: pass:[<span class="todo-keyword"><strong>TODO</strong></span>]
...
= NUPANO RESTful API Guidelines
link:https://github.com/NUPANO/restful-api-guidelines[GitHub Repository]
