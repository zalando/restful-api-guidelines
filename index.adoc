...
// links to internal 
:api-guild: https://confluence.linz.govt.nz/display/STEP/STEP+Engineering+Design+Group
...
:lilly-ui: https://lilly.nonprod.enablement.awsint.linz.govt.nz/
...
:resources: pass:[<a href="#resources"><code>resources</code></a>]
:_links: pass:[<a href="#_links"><code>_links</code></a>]


// Attributes to improve linking to special definition anchors.
:Idempotency-Key: pass:[<a href="#230"><code>Idempotency-Key</code></a>]
:X-LINZ-Correlation-Id: pass:[<a href="#X-linz-correlation-id"><code>X-LINZ-Correlation-Id</code></a>]
...
:Correlation-ID: pass:[<a href="#correlation-id"><code>Correlation-ID</code></a>]
...
= Linz Step RESTful API and Event Guidelines
link:https://github.com/linz/restful-api-guidelines[Github Repository]
