...
:creator: IST Group AB
:producer: Asciidoctor
:keywords: IST, Guidelines, RESTful, API, Events, Schema
...
// links to internal
:api-guild: https://educloud.ist.com/api-docs/
:api-linter: https://stash.ist.com/projects/TI/repos/api-linter/browse
:api-review-proc: https://api.docs.zalando.net/howto/request-review/
:api-portal: https://educloud.ist.com
:api-repository: https://ist.com/
...
These guidelines are based on link:https://github.com/zalando/restful-api-guidelines[Zalando's REST Guidelines] and repurposed for IST's needs.

Other formats: link:IST-REST-guidelines.pdf[PDF], link:IST-REST-guidelines.epub[EPUB3] +
