...
:creator: DailyPay Inc.
:producer: Asciidoctor
:keywords: DailyPay, Guidelines, RESTful, API, Events, Schema
...
= DailyPay RESTful API and Event Guidelines
link:https://github.com/dailypay/restful-api-guidelines[Github Repository]

image::assets/api-dailypay-small.png[API Guild Logo]

Other formats: link:dailypay-guidelines.pdf[PDF], link:dailypay-guidelines.epub[EPUB3] +
