...
:keywords: Hypatos, Guidelines, RESTful, API, Events, Schema
...
image::assets/hypatos-logo.svg[Hypatos]

Other formats: link:hypatos-guidelines.pdf[PDF], link:hypatos-guidelines.epub[EPUB3] +
