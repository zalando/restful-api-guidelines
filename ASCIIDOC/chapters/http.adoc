...
of
link:../headers/CommonHeaders.md#could-consider-using-etag-together-with-ifnonematch-header[`ETag`
and `If-(None-)Match`] headers should be considered to signal the server
...
link:../compatibility/Compatibility#compatibility[backwards compatible
...
(http://erosb.github.io/post/json-patch-vs-merge-patch[see also]).

To prevent unnoticed concurrent updates when using PATCH, the
combination of
link:../headers/CommonHeaders.md#could-consider-using-etag-together-with-ifnonematch-header[`ETag`
and `If-Match`] headers should be considered to signal the server
stricter demands to expose conflicts and prevent lost updates.
...
* You should provide good documentation in the API definition when using
HTTP status codes that are less commonly used and not listed below.
...
[width="12%",cols="34%,33%,33%",options="header",]
|=======================================================================
...
link:../headers/CommonHeaders.md[Common Headers section].) _Always_ set
the Location header. |POST, PUT
...
link:../http/Http.md#must-use-207-for-batch-or-bulk-requests["Use 207
for Batch or Bulk Requests"]. |POST
|=======================================================================
...
link:../http/Http.md#must-use-429-with-headers-for-rate-limits["Use 429
with Headers for Rate Limits"]. |All
|=======================================================================
...
link:../common-data-types/CommonDataTypes.html#must-use-common-error-return-objects[_Use
Common Error Return Objects_].
...
`401 Unauthorized` - `403 Forbidden` - `404 Not Found` unless it has
some additional semantics - `405 Method Not Allowed` -
`406 Not Acceptable` - `408 Request Timeout` - `413 Payload Too Large` -
...
expressed with
link:../common-data-types/CommonDataTypes.html#must-use-common-error-return-objects[_Problem
types_].
...
\{\{ book.should }} Explicitly define the Collection Format of Query
Parameters
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
