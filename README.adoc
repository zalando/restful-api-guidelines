= Developing Restful APIs: A Comprehensive Set of Guidelines by LINZ
...
LINZ EDG has leveraged the heavy lifting the Zalando Tech team has done with their comprehensive set of guidelines and
