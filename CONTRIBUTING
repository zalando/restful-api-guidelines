...
## Issues
Found a bug or have an idea for a feature? You can help us by [creating an issue](https://github.com/zalando-incubator/zally/issues).
Just make sure that an issue describing the bug or feature does not already exist. You can go even further and
[open a Pull Request](https://github.com/zalando-incubator/zally/pulls) with the fix or proposed feature.

## Pull Requests
Follow these steps to contribute your work to Zally:

1. [Open an issue](https://github.com/zalando-incubator/zally/issues) describing the problem or proposed feature. Assign yourself so we know you're working on it.
1. Fork this repo and create a branch for your work.
1. Push changes to your branch.
1. Test your changes.
1. Open a [Pull Request](https://github.com/zalando-incubator/zally/pulls) when your code is ready for review.
